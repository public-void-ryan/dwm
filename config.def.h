...
const char *lfcmd[] =  {TERMINAL, "-n", "lf", "-g", "120x24", "-e", "lf", NULL };
...
/* tagging */
/* \uf120 = terminal, \uf269 = firefox, \uf3a5 = obsidian, \uf0e0 = email, \uf144 = freetube, \uf392 = discord, \uf1bc = spotify, \uf2ce = pocketcasts */
...
static const Rule rules[] = {
	...
	*/
	...
	{ "vesktop",       "vesktop",       NULL,         1 << 5,       0,           0,         0,        -1 },
	{ TERMCLASS,  NULL,       NULL,       	    0,            0,           1,         0,        -1 },
	{ "pocket-casts-linux",   NULL,             NULL,         1 << 7,       0,  0,      0,        -1 },
	{ TERMCLASS,  NULL,       NULL,       	    0,            0,           1,         0,        -1 },
...
/*	{ MODKEY|ShiftMask,		XK_o,		incnmaster,     {.i = -1 } }, */
	...
	/*{ 0, XF86XK_WLAN,		spawn,		SHCMD("nmtui") },*/
